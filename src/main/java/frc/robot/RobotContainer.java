...
public class RobotContainer {
        ...
        private final Command SimpleTestAuton = new SequentialCommandGroup(
                        ...
                        new AutonHandoffCommand(handoff, 0.0, sensors, false),
                        new WaitCommand(2),
                        new ParallelRaceGroup(  // Note: ParallelRaceGroup, not Command.  Will end when any of the commands finish
                                        new AutonIntakeCommand(intake,
                                                        MiscMapping.INTAKE_SPEED,
                                                        sensors),
                                        new AutonHandoffCommand(handoff,
        ...
        public Command getAutonomousCommand() {
                ...
                if (!sensors.getAutonAllianceSelected()) {
                        // BLUE side Autons
                        SmartDashboard.putString("AutonSelector", "BLUE " + sensors.getAutonSelected());
                        switch (sensors.getAutonSelected()) {
                                ...
                                case 5:
                                        return TwoNoteAuton; // BLUE TwoNoteAuton - This is the default for the bot!
                                default:
                                        return SimpleTestAuton; // BLUE TwoNoteAuton - This is the default for the bot!
                        }
                } else {
                        // RED side Autons
                        SmartDashboard.putString("AutonSelector", "RED " + sensors.getAutonSelected());
                        switch (sensors.getAutonSelected()) {
                                case 1:
